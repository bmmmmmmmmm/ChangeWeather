    ...
    render() {
        return (
            <Descriptions bordered>
                <Descriptions.Item label="国家">{this.props.country}</Descriptions.Item>
                <Descriptions.Item label="省份">{this.props.province}</Descriptions.Item>
                ...
                <Descriptions.Item label="天气获取时间" span={2}>{this.props.reporttime}</Descriptions.Item>
            </Descriptions>
        )
    }
}
